...
app.use(serve(path.join(__dirname, 'build/static')))
app.use(serve(path.join(__dirname, 'build/static/css')))
app.use(serve(path.join(__dirname, 'build/static/js')))
app.use(serve(path.join(__dirname, 'build/static/media')))
